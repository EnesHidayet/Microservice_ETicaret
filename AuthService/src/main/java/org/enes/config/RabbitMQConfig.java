...
public class RabbitMQConfig {
    ...
    /**
     * DİKKAT!!!!!
     * özellikle yapılması gerekenler ortamda Queue, Exchange, Binding nesnelerinin olması gerekmektdir.
     */

    /**
     * 1. Exchange nesnesi ortama sağlanmalıdır.(Direct, Fanout, Topic gibi)
     * Lütfen bunu düşünün, Spring çalışma yapısında spring application context içine nesneleri yaratarak ekler
     * bu nesne yaratma işlemi Bean olarak adlandırılır.Burada eklediğimiz methodlar nesne döndüğü için
